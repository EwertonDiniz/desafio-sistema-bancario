...
builder.Services.AddHttpClient<IContaCorrenteService, ContaCorrenteService>((provider, client) =>
{
    ...
    if (string.IsNullOrWhiteSpace(baseUrl))
        throw new InvalidOperationException("A URL do servi�o ContaCorrente n�o foi configurada corretamente.");
...
if (string.IsNullOrEmpty(secret))
    throw new InvalidOperationException("JwtSettings:Secret n�o foi configurado!");
